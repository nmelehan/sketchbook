...
public class sketch_0531b extends PApplet {
...
int sketchBackgroundColor = color(100);
...
public static interface HConstants {
	...
	public static final float D2R = PConstants.PI / 180f, R2D = 180f / PConstants.PI, SQRT2 = 1.4142135623730951f, PHI = 1.618033988749895f, PHI_1 = 0.618033988749895f, TOLERANCE = (float)10e-6f, EPSILON = (float)10e-12f;
...
public static class HMath implements HConstants {
	...
	public static float[] absLocArr(HDrawable ref, float relX, float relY) {
		...
		public static int solveCubic( float a, float b, float c, float d, float[] roots ) {
			...
			float A = (q>0?-1:1) * (float)Math.pow(Math.abs(q) + Math.sqrt(D), 1.0f/3.0f);
			roots[0] = A + p/A - b;
			return 1;
		}
...
public void drawHandles(PGraphics g, HVertex prev,float drawX,float drawY) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_0531b" };
    if (passedArgs != null) {
